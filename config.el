...
(setq user-full-name "Akshit Kumar"
      user-mail-address "akshit.kumar@research.iiit.ac.in")
...
(setenv "PATH" (concat (getenv "PATH") ":/Users/akshitkr/.ghcup/hls/2.4.0.0/bin/haskell-language-server-wrapper"))
...
(after! circe
  (set-irc-server! "irc.libera.chat"
    `(:tls t
      :port 6697
      :nick "komikat"
      :sasl-username "komikat"
      :sasl-password (getenv "IRCPASS")
